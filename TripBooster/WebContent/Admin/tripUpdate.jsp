...
<%
		try {
			...
			String sql = "SELECT tripCode, tripSort, tripName, tripLoca, tripImg, tripPerson, tripParking, tripContent, tripTel, userTel FROM triptbl WHERE tripNum = ?";
...
<div class="container mt-4">
    ...
    <form action="tripUploadAction.jsp" method="POST" enctype="multipart/form-data">
    	...
    	<p>여행지 이름 : <input type="text" name="tripName" value=""><br>
